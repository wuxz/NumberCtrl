========================================================================
		ActiveX Control DLL : BHMNUMBER
========================================================================

ControlWizard has created this project for your BHMNUMBER ActiveX Control
...
that make up your BHMNUMBER ActiveX Control DLL.
...
BHMNumberCtl.h
	This file contains the declaration of the CBHMNumberCtrl C++ class.

BHMNumberCtl.cpp
	This file contains the implementation of the CBHMNumberCtrl C++ class.

BHMNumberPpg.h
	This file contains the declaration of the CBHMNumberPropPage C++ class.

BHMNumberPpg.cpp
	This file contains the implementation of the CBHMNumberPropPage C++ class.

BHMNumberCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CBHMNumberCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file BHMNumber.rc.
